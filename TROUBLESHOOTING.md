...
retry. Failing/disabled feeds are always surfaced here - never silently dropped. Use _retry
now_ / _re-enable_ to reset `failure_count` and `disabled` and wake the scheduler.
