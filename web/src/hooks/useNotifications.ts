...
import type { NotificationConfig, PutNotifications, TestResult } from "@/lib/types";
...
export function useUpdateNotifications() {
  ...
  return useMutation({
    mutationFn: (body: PutNotifications) => api.put<NotificationConfig>("/notifications", body),
