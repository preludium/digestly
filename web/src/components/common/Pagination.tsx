...
/** Numbered prev/next pagination with "Page X of Y" (prompt.md §9.1 — NOT infinite scroll).
 *  Reused by the feed and search grids. */
export function Pagination({
  ...
  return (
    <nav className="flex flex-wrap items-center justify-center gap-2" aria-label="Pagination">
      ...
      <span className="ml-2 w-full text-center text-sm text-muted-foreground sm:w-auto">
