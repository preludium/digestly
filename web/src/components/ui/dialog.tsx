...
>(({ className, children, ...props }, ref) => (
    <DialogPortal>
        <DialogOverlay />
        {/* Full-screen bottom sheet on mobile; centered card on ≥sm (prompt.md §9.3). */}
        <DialogPrimitive.Content
            ref={ref}
            className={cn(
                "fixed z-50 flex flex-col gap-4 border border-border bg-background p-6 shadow-lg",
                "inset-x-0 bottom-0 max-h-[92dvh] overflow-y-auto rounded-t-lg",
                "sm:inset-auto sm:left-1/2 sm:top-1/2 sm:max-h-[85dvh] sm:w-full sm:max-w-lg sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-lg",
