...
toolchain, or server change. What you *don't* get vs. Tauri: Keystore-backed token, biometric
...
- Building B–E in *this* environment isn't possible; the plan is structured so we get real,
